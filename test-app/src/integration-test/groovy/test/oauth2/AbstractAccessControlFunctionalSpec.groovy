...
import helper.FunctionalTestConfig
import helper.GrantTypes
import helper.TestEnvironmentCleaner
import pages.*

@Integration
abstract class AbstractAccessControlFunctionalSpec extends GebSpec {
    ...
    private String getAbsoluteUrl(String relativeUrl) {
        return FunctionalTestConfig.BASE_URL + relativeUrl
    }

    protected void attemptUnauthorizedResourceRequest(String relativeUrl) {
        try {
            def requestUrl = getAbsoluteUrl(relativeUrl)
